...
document.head.appendChild(style);\n\n// Feature terminal demo functionality (ensure it runs after DOM is loaded)\ndocument.addEventListener('DOMContentLoaded', function() {\n    const featureBtns = document.querySelectorAll('.feature-btn');\n    const featureDemos = document.querySelectorAll('.feature-demo');\n    \n    featureBtns.forEach(btn => {\n        btn.addEventListener('click', function() {\n            const targetDemo = this.getAttribute('data-demo');\n            \n            // Remove active class from all buttons and demos\n            featureBtns.forEach(b => b.classList.remove('active'));\n            featureDemos.forEach(d => d.style.display = 'none');\n            \n            // Add active class to clicked button and show corresponding demo\n            this.classList.add('active');\n            const targetElement = document.getElementById(targetDemo);\n            if (targetElement) {\n                targetElement.style.display = 'block';\n            }\n        });\n    });\n    \n    // Auto-cycle through feature demos\n    let currentFeatureIndex = 0;\n    const featureButtons = document.querySelectorAll('.feature-btn');\n    \n    function cycleFeatureDemo() {\n        if (featureButtons.length > 0) {\n            featureButtons[currentFeatureIndex].click();\n            currentFeatureIndex = (currentFeatureIndex + 1) % featureButtons.length;\n        }\n    }\n    \n    // Start auto-cycling after 5 seconds, then every 4 seconds\n    setTimeout(() => {\n        setInterval(cycleFeatureDemo, 4000);\n    }, 5000);\n});